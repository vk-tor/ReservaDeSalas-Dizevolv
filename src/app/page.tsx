...
export default function HomePage() {
  ...
  const filteredRooms = roomsQuery.data?.filter(r => {
    const matchesSearch = r.name.toLowerCase().includes(searchQuery.toLowerCase());
    const matchesCapacity = r.capacity >= (parseInt(minCapacity) || 0);
        ...
        {!selectedRoomId ? (
          <div className="w-full max-w-7xl mx-auto px-6 py-12 animate-slide-in">
            <div className="text-center mb-16">
              ...
              <div className="mt-10 max-w-2xl mx-auto flex flex-col sm:flex-row gap-4 relative group">
